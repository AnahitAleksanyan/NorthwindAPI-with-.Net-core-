...
namespace NorthwindAPI.ContextService
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<CourseCustomerCast> CourseCustomerCasts { get; set; }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-TB1NPBD\\SQLEXPRESS;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CourseCustomerCast>(entity =>
            {
                entity.HasOne(cc => cc.Course)
                      .WithMany(cc => cc.CourseCustomerCasts)
